...
module collections {
    ...
    */
    ...
    export class Heap<T> {
        ...
        containsSetFunction(element: T, equalsFunction?: IEqualsFunction<T>): boolean {
            return collections.arrays.contains(this.data, element, equalsFunction);
        }
    ...
    export class PriorityQueue<T> {
        ...
        containsSetFunction(element: T, equalsFunction?: IEqualsFunction<T>): boolean {
            return this.heap.containsSetFunction(element, equalsFunction);
        }
