...
(function (Astar) {
    ...
    Astar.SearchResult = SearchResult;
    /**
     ...
     */
    function findPath(start, end, gen, heuristic) {
        //Simple case:
        if (start.equals(end)) {
            return new SearchResult([start, end], 0);
        }
        var known = new collections.Dictionary();
        var dist = [];
        var prev = [];
        var nodes = [];
        var count = 0;
        ...
        var pQueue = new collections.PriorityQueue(comparer);
        ...
        if (known.containsKey(end)) {
            ...
            return new SearchResult(path.reverse(), iterations);
        }
        else {
            return new SearchResult();
        }
...
var Cell = (function () {
    ...
    Cell.prototype.equals = function (object) {
        var cell = object;
