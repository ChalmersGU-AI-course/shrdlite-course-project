...
function dummyGoal(x) {
    return x == goal;
}
function dummyCall() {
    return astar(dummyF, dummyCost, dummyH, 0, dummyGoal);
}
/// <reference path="lib/collections.ts" />
/// <reference path="Astar.ts" />
//-- Definitions ----------------------------------------
...
var pStart = new PState([[7, 2, 4], [5, 0, 6], [8, 3, 1]], 1, 1);
// var pStart : PState = new PState(
//         [[8,3,1],
//          [0,5,7],
//          [4,6,2]], 1, 0);
var pGoal = new PState([[0, 1, 2], [3, 4, 5], [6, 7, 8]], 0, 0);
...
function testMain() {
    ...
    var gr = graphRun();
    var res = runPuzzle();
    show = "" + "<p>$ dummy: " + d + "<p>$ graph: " + gr + "<p>$ 8-puzzle: start heuristic = " + puzzleHeuristic(pStart) + "<p> path length = " + res.length + "<p>" + res;
