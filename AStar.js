...
(function (AStar) {
    ...
    AStar.example1 = example1;
    function example1HeurFunction(t) {
        return t.hweight;
    }
    function example2() {
        var graph2 = {};
        ...
        var optPath = astar(0 /* Arad */, 1 /* Bucharest */, example2HeurFunction, graph2);
        for (var i in optPath) {
            var j = i;
            console.log(i - (-1), City[optPath[(optPath.length - 1) - i]]);
        }
    }
    AStar.example2 = example2;
    var City;
    (function (City) {
        City[City["Arad"] = 0] = "Arad";
        City[City["Bucharest"] = 1] = "Bucharest";
        City[City["Chraiova"] = 2] = "Chraiova";
        City[City["Dobreta"] = 3] = "Dobreta";
        City[City["Eforie"] = 4] = "Eforie";
        City[City["Fagaras"] = 5] = "Fagaras";
        City[City["Giurgiu"] = 6] = "Giurgiu";
        City[City["Hirsova"] = 7] = "Hirsova";
        City[City["Iasi"] = 8] = "Iasi";
        City[City["Lugoj"] = 9] = "Lugoj";
        City[City["Mehadia"] = 10] = "Mehadia";
        City[City["Neamt"] = 11] = "Neamt";
        City[City["Oreada"] = 12] = "Oreada";
        City[City["Pitesti"] = 13] = "Pitesti";
        City[City["RimnicuVilecea"] = 14] = "RimnicuVilecea";
        City[City["Sibiu"] = 15] = "Sibiu";
        City[City["Timisoara"] = 16] = "Timisoara";
        City[City["Urziceni"] = 17] = "Urziceni";
        City[City["Vaslui"] = 18] = "Vaslui";
        City[City["Zerind"] = 19] = "Zerind";
    })(City || (City = {}));
    ;
    function example2HeurFunction(input) {
        switch (input) {
            case 0:
                return 366;
                break;
    ...
    function astar(start, goal, huerFunction, graph) {
        var closedSet = [];
        var openSet = new collections.PriorityQueue(compareT);
        ...
        while (!openSet.isEmpty()) {
            ...
            for (var ei in current.neighbours) {
                var e = current.neighbours[ei];
                if (!arrayIsMember(e[1], closedSet)) {
                    var tentative_g_score = g_score[current.id] + e[0];
