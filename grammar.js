...
var grammar = {
    ...
    {"name": "command", "symbols": ["Q_how_many", "objectPL", "are_there"], "postprocess": R({command:"Q_how_many", entity:1})},
    {"name": "command", "symbols": ["Q_where_is", "entity"], "postprocess": R({command:"Q_where_is", entity:1})},
    ...
    {"name": "quantifierPL$subexpression$1$string$1", "symbols": [{"literal":"t"}, {"literal":"h"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "quantifierPL$subexpression$2$string$1", "symbols": [{"literal":"a"}, {"literal":"l"}, {"literal":"l"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "quantifierPL$subexpression$2", "symbols": ["quantifierPL$subexpression$2$string$1"]},
    {"name": "quantifierPL", "symbols": ["quantifierPL$subexpression$2"], "postprocess": R("all")},
    ...
    {"name": "Q_how_many$string$1", "symbols": [{"literal":"h"}, {"literal":"o"}, {"literal":"w"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Q_how_many$string$2", "symbols": [{"literal":"m"}, {"literal":"a"}, {"literal":"n"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Q_how_many", "symbols": ["Q_how_many$string$1", "Q_how_many$string$2"]},
    {"name": "Q_where_is$string$1", "symbols": [{"literal":"w"}, {"literal":"h"}, {"literal":"e"}, {"literal":"r"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Q_where_is$string$2", "symbols": [{"literal":"i"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Q_where_is", "symbols": ["Q_where_is$string$1", "Q_where_is$string$2"]},
    {"name": "Q_where_is$string$3", "symbols": [{"literal":"w"}, {"literal":"h"}, {"literal":"e"}, {"literal":"r"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Q_where_is$string$4", "symbols": [{"literal":"a"}, {"literal":"r"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Q_where_is", "symbols": ["Q_where_is$string$3", "Q_where_is$string$4"]},
    ...
    {"name": "are_there$string$1", "symbols": [{"literal":"a"}, {"literal":"r"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "are_there$string$2", "symbols": [{"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":"r"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "are_there", "symbols": ["are_there$string$1", "are_there$string$2"]},
    {"name": "are_there$string$3", "symbols": [{"literal":"i"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "are_there$string$4", "symbols": [{"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":"r"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "are_there", "symbols": ["are_there$string$3", "are_there$string$4"]},
